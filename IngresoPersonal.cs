...
namespace ControlDePersonal_Pro
{
    public partial class IngresoPersonal : Form
    {
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            ...
            string sql = "UPDATE personal SET NombrePersonal='" + nombres + "', ApellidoPersonal= '" + apellidos + "', CargoPersonal= '" + cargo + "', CorreoPersonal='" + correo + "', Contaseña='" + contrasena + "' WHERE IdPersona='" + id + "'";
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            string sql = "DELETE FROM personal WHERE IdPersona='" + id + "'";
        ...
        private void BtnBuscar_Click(object sender, EventArgs e)
        {
            ...
            string sql = "SELECT IdPersona, NombrePersonal, ApellidoPersonal, CargoPersonal, CorreoPersonal, Contaseña FROM personal WHERE IdPersona LIKE '" + id + "' LIMIT 1";
            MySqlConnection conexionBD = Conexion.conexion();
            conexionBD.Open();
